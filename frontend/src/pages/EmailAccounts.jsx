    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Configure inbound and outbound email connections</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-gray-400">No email accounts configured yet.</div>
      ) : (
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-3">
                    <span className="font-semibold text-gray-900">{a.email_address}</span>
                    <Badge active={a.is_active} />
                    <span className="text-xs text-gray-400 bg-gray-50 px-2 py-0.5 rounded">{a.provider}</span>
                  </div>
                  {a.display_name && <p className="text-sm text-gray-500 mt-1">{a.display_name}</p>}
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <hr />
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">IMAP (Inbound)</p>
              ...
              <hr />
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">SMTP (Outbound)</p>
              <div className="grid grid-cols-3 gap-4">
                <div className="col-span-2">
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
              <button onClick={() => setShowModal(false)} className="px-4 py-2 text-gray-600 hover:text-gray-800 text-sm">Cancel</button>

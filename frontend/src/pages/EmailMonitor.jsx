  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Email Monitor</h1>
      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            <StatCard label="Total Accounts"   value={stats?.total_accounts}   color="text-gray-800" />
          ...
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Connected Accounts</h2>
          {!stats?.accounts?.length ? (
            <p className="text-sm text-gray-400">No email accounts configured.</p>
          ) : (
                ...
                <div key={a.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-3">
                      <span className="font-medium text-gray-900">{a.email_address}</span>
